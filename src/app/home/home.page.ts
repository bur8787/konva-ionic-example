        ...
        images.forEach((image) => {
                ...
                Konva.Image.fromURL(image.attrs.url, (img) => {
                    ...
                    img.on('click', (e) => {
                        ...
                        this.selectedTarget.stroke('#3880FF');
